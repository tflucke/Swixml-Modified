 ...
 * When ran locally using SUN's AppletViewer, the file needs to be made
 * available here:
 * C:\Temlp\xml\...
 *
...
{
	private static final long serialVersionUID = -6059322393939560712L;
	...
	{
		private static final long serialVersionUID = -5043593402723374110L;
	...
	public void init()
	{
		...
		try
		{
			...
			new SwingEngine(this).insert(
			        new URL(getCodeBase(), descriptorfile), this);
